...
print('[TSAN] provenance module=sys shared=target-objects(3obj+0cls+0plugin+module) weird=0 args=list,dict,set,bytearray iterators=8+3ext iter_off=6 roles=r/w/both ops=a-i workers=4 iters=200 funcs=40', file=stderr)
...
_tsan_funcs = ['__breakpointhook__', '__displayhook__', '__excepthook__', '__interactivehook__', '__unraisablehook__', '_current_exceptions', '_current_frames', '_getframe', 'addaudithook', 'audit', 'breakpointhook', 'call_tracing', 'callstats', 'displayhook', 'exc_info', 'excepthook', 'exception', 'exit', 'get_asyncgen_hooks', 'get_coroutine_origin_tracking_depth', 'get_int_max_str_digits', 'getcheckinterval', 'getdefaultencoding', 'getdlopenflags', 'getfilesystemencodeerrors', 'getfilesystemencoding', 'getprofile', 'getrecursionlimit', 'getsizeof', 'getswitchinterval', 'gettrace', 'intern', 'is_finalizing', 'pypy_find_executable', 'pypy_find_stdlib', 'pypy_initfsencoding', 'pypy_resolvedirof', 'set_asyncgen_hooks', 'set_coroutine_origin_tracking_depth', 'set_int_max_str_digits']
...
_tsan_obj_factories = []
_tsan_obj_factories.append(lambda: getattr(fuzz_target_module, '__stdout__'))
_tsan_obj_factories.append(lambda: getattr(fuzz_target_module, 'pypy_version_info'))
...
try:
    ...
    pass
_tsan_iter_factories.append(lambda: iter(getattr(fuzz_target_module, '__stdout__')))
_tsan_iter_factories.append(lambda: iter(getattr(fuzz_target_module, 'pypy_version_info')))
