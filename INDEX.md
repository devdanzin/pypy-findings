...
| [`PYPY-FUZZ-007`](reports/PYPY-FUZZ-007-threadpool-at-address-space-limit-segv/report.md) | SIGSEGV | `ThreadPool()` at an address-space limit | 6/8 at `ulimit -v 524288` with no ballast; via ballast, sweeps 6-7/10 at the right size and 0/10 one step either side | 22249-line generated script -> 4 lines |
